  ...
  <main className="main-content">
    ...
    <div className="pictures">
      <div className="first-presentation">
        <img src={bigPackage} alt="nécessaire de naissance (cap de bain, gant de toilette, hochet et balle de préhension" className="picture1" />
      ...
      <div className="second-presentation">
        <img src={threeBalls} alt="trois balles de préhension" className="picture2" />
        <p className="description">"Balles de préhension en veux-tu, en voilà ! Pleins de couleurs et de textures différentes" </p>
      </div>
      <div className="third-presentation">
        <img src={ballsAndRabbit} alt="ensemble balle de préhension et hochet lapin" className="picture3" />
